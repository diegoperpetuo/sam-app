...
const QtdPeca = async (qtdValue: number) => {
  try {
    const response2 = await fetch(`https://localhost:8000/plc/siemens/write?ip=${config_pedido.ip}&data_type=${config_pedido.data_type}&value=${qtdValue}`, {
      method: 'POST',
      headers: {
...
const Pedido = async (totalValue: number) => {
  try {
    const response1 = await fetch(`https://localhost:8000/plc/siemens/write?ip=${config_pedido.ip}&data_type=${config_pedido.data_type}&value=${totalValue}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const Pedido2 = async () => {
  const response2 = await fetch(`https://localhost:8000/plc/siemens/write?ip=${config_pedido.ip}&data_type=${config_pedido.data_type2}&value=0`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
const Pedido3 = async () => {
  const response3 = await fetch(`https://localhost:8000/plc/siemens/write?ip=${config_pedido.ip}&data_type=${config_pedido.data_type2}&value=1`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
const Alerta = async (setMessage: (message: string) => void, fadeAnim: Animated.Value) => {
  try {
    const response = await fetch(`https://localhost:8000/plc/siemens/read?ip=${config_pedido.ip}&data_type=${config_pedido.data_type2}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
const TipoPeca = async () => {
  const response3 = await fetch(`https://localhost:8000/plc/siemens/write?ip=${config_pedido.ip}&data_type=${config_pedido.data_type}&value=2`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
